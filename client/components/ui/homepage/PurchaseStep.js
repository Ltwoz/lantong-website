const PurchaseStep = () => {
    return (
        <div className="w-full overflow-auto">
            <div className="flex md:grid md:grid-cols-4 gap-4 md:gap-9 justify-center w-fit">
                {/* Card ขั้นตอน 1 */}
                <div className="relative w-[273px] md:w-full bg-white border border-[#D3D3D3] rounded-lg overflow-hidden h-[300px]">
