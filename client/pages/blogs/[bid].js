          ...
          <div className="flex flex-col gap-4 xl:gap-6 bg-white p-4 rounded">
            ...
            <div className="flex flex-col gap-3">
              <h4 className="text-xl font-bold">
                หมวดหมู่ : <span className="font-normal">{blog.category}</span>
              </h4>
              <h4 className="text-xl font-bold">
                ที่อยู่ : <span className="font-normal">{blog.address}</span>
              </h4>
            </div>
            <hr />
            {/* คำอธิบาย */}
            ...
            <div className="flex flex-col xl:flex-row gap-6">
              {containMap && <GoogleMapComponent url={blog.google_map} />}
              <div
                className={`w-full ${
