      ...
      <div className="md:w-[1200px] mx-auto md:flex md:border rounded shadow md:p-8 w-full px-4 gap-10">
        <div className="md:ml-8 ">
          ...
          <div className="flex flex-col gap-4">
            ...
            {/* Facebook */}
            <Link href={"#"}>
              <div className="md:hover:bg-slate-50 md:text-start text-center md:bg-transparent bg-[#4267B2] rounded-md">
            ...
            {/* Line */}
            <Link href={"#"}>
              <div className="md:hover:bg-slate-50 md:text-start text-center md:bg-transparent bg-[#06C755] rounded-md">
            ...
            {/* Email */}
            <Link href={"#"}>
              <div className="md:hover:bg-slate-50 md:text-start text-center md:bg-transparent bg-[#FF5A60] rounded-md">
            ...
            <div className="flex flex-col">
              <h1 className="font-semibold md:text-[18px]">
                Address
              </h1>
              <div className="flex items-center">
                <FaRoad className="md:w-[50px] md:h-[50px] w-[100px] h-[100px] mr-2 md:mr-2 mt-2" />
                <p>
                ห้างหุ้นส่วนจำกัด ลานทองธุรกิจยนต์ 4/4 ถ.รัตนโกสินทร์ ต.ช้างม่อย อ.เมืองเชียงใหม่ จ.เชียงใหม่
                  50200
                </p>
              </div>
            </div>
