        ...
        <div className="md:w-[1200px] border mx-auto w-[375px]">
          ...
          <Link href="#">
            <div className="bg-[#4267B2] h-[300px] md:flex items-center mt-[125px] ">
              <BsFacebook className="md:w-[200px] md:h-[200px] md:ml-[56px] ml-auto mr-auto w-[100px] h-[100px]" />
          ...
          {/* Line */}
          <Link href="#">
            <div className="bg-[#06C755] h-[300px] md:flex items-center mt-[35px] ">
              <FaLine className="md:w-[200px] md:h-[200px] md:ml-[56px] w-[100px] ml-auto mr-auto h-[100px]" />
              <h1 className="text-white md:text-[74px] md:ml-[182px] text-[24px] text-center">
                lantongshop
              </h1>
            </div>
          ...
          {/* Email */}
          <Link href="#">
            <div className="bg-[#FF5A60] h-[300px] md:flex items-center mt-[35px] ">
              <HiOutlineMail className="md:w-[200px] md:h-[200px] md:ml-[56px] ml-auto mr-auto w-[100px] h-[100px]" />
